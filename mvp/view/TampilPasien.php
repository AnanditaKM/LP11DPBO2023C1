	...
	function tampil()
	{
		...
		for ($i = 0; $i < $this->prosespasien->getSize(); $i++) {
			...
			<td>" . $this->prosespasien->getTelp($i) .
				"</td>
			<td>
				<a href='index.php?action=add&id=" . $this->prosespasien->getId($i) . "'><button type='button' class='btn btn-warning'>Edit</button></a>
            	<a href='index.php?action=delete&id=" . $this->prosespasien->getId($i) . "'><button type='button' class='btn btn-danger' >Hapus</button></a>
          	</td>";
		}
